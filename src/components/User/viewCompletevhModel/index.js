...
class viewCompletevhModel extends Component {
    render() {
        return (
            <UserHeader>
    ...
    <section id="main-content" className="hide-sidebar">
		...
		<div className="row vhmdlbtnalign">
			<div className="col-md-6 ">
                    <ul className="breadcrumbs-alt">
                        ...
                        <li>
                            <a href="vhmodel.html" className="">VH model</a>
                        </li>
                        <li>
                            <a href="viewcompletevhmodel.html" className="current">View Complete VH Model</a>
                        </li>
        ...
        {/*  page start */}
                ...
                <header className="main-bg vcvhmdlhead">
                        <div className="col-md-12"><h4>Dashboard Calculations</h4></div>
                </header>
            ...
            <div className="col-md-12">
                ...
                <div className="row vhmodeltableadjst">
                    <div className=" col-md-6">
                          <div className="table-responsive">
							<table className="table table-hover table-striped vhmodeltable seconchildalign">
								<thead>
            ...
            <div className="clearfix"></div>
            <header className="main-bg vcvhmdlhead">
                        <div className="col-md-12"><h4>Con. Period Cash Flows </h4></div>
                </header>
            <div className="col-md-12">
            <div className="table-responsive">
                 ...
                 <div className="clearfix"></div>
            <header className="main-bg vcvhmdlhead">
                        <div className="col-md-12"><h4>Stabilized Pro Forma </h4></div>
                </header>
                <div className="col-md-12">
                <div className="table-responsive">
							...
							<table className="table  table-hover table-striped  verticaltbl project-value">
								<thead>
									<tr>
                                        ...
                                        <td ><p style={{"textAlign":"right !important"}}>Cap Rate Based On Project Basis</p><p style={{"textAlign":"center !important"}}>(%)</p></td>
                                        <td> <p style={{"textAlign":"right !important"}}>Cap Rate Based On Project Basis</p> <p style={{"textAlign":"center !important"}}>($)</p></td>
                                        <td><p style={{"textAlign":"right !important"}}>Value per Unit</p> <p style={{"textAlign":"center !important"}}>($)</p></td>
                                        <td><p style={{"textAlign":"right !important"}}>Construction Loan Debt Yield</p> <p style={{"textAlign":"center !important"}}>(%)</p></td>
                                        <td><p style={{"textAlign":"right !important"}}>className A Debt Yield </p><p style={{"textAlign":"center !important"}}>(%)</p></td>
                                        <td><p style={{"textAlign":"right !important"}}>className B Debt Yield</p> <p style={{"textAlign":"center !important"}}>(%)</p></td>
            ...
            <div className="clearfix"></div>
            <header className="main-bg vcvhmdlhead">
                        <div className="col-md-12"><h4>Financing Schedule 
</h4></div>
                </header>
            <div className="col-md-6">
            <div className="table-responsive">
 ...
 */}
   ...
   <tr>
      ...
      <td>28.71%</td>
                ...
                <div className="col-md-12">
                     <a className="default-btn cpbtn1 pull-right" href="viewcompletevhmodel.html">Download VH Mode</a>
                </div>
...
export default viewCompletevhModel;
